midi('musical instrument device interface') {
    input ('MIDI input') {
        note('note on/off from 0 thru 127') {
            on  (chan 0_15, num 0_127, velo 0_127, port 0, time 0)
            off (chan 0_15, num 0_127, velo 0_127, port 0, time 0)
        }
        afterTouch (chan 0_15, num 0_127, val 0_127, port 0, time 0)
        pitchWheel (chan 0_15, val 0_16384=8192, port 0, time 0)
        program    (chan 0_15, num 0_255, port 0, time 0)
        nrpn       (chan, num 0_16383, val 0…1, time 0, -> skypad˚.)
        controller (chan 0_15, cc 0_127, val 0_127, port 0, time 0, -> cc.roli˚.)
    }
